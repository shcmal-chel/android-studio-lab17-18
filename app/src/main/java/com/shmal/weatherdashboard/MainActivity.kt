package com.shmal.weatherdashboard
...
import com.shmal.weatherdashboard.ui.theme.WeatherDashboardTheme
import com.shmal.weatherdashboard.viewmodel.WeatherViewModel
...
fun WeatherDashboardScreen(
    ...
    Column(
        ...
        WeatherCard(
            emoji = "🌡",
            title = "Temperature",
            value = weatherState.temperature?.let { "$it℃" } ?: "-",
